...
\textit{Descripción}: como desarrollador, quiero implementar en el servidor MCP la herramienta de análisis PERVAL diseñada en US08, de forma que, dado un modelo BPMN y un conjunto de tareas, el sistema devuelva la clasificación por dimensiones, el resumen agregado y el valor general.
...
\textit{Descripción}: como desarrollador, quiero validar la solución desarrollada mediante una evaluación con un grupo de aproximadamente quince usuarios, empleando el modelo de aceptación de la tecnología (\textit{Technology Acceptance Model}, TAM), de forma que pueda valorar la utilidad percibida, la facilidad de uso percibida y la intención de uso del sistema.
