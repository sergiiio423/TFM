...
Los componentes internos de la solución son la extensión sobre bpmn.io, el servidor MCP y el módulo de análisis PERVAL y se representan dentro de la frontera del sistema.
...
El actor \textbf{Usuario} interactúa exclusivamente con la extensión cliente sobre \textit{bpmn.io}, sin tener visibilidad directa de las comunicaciones entre el servidor MCP y el \textbf{Proveedor de LLM}. Esta separación de responsabilidades da lugar a los diferentes diagramas de contexto que delimitan cada subsistema, presentados a continuación.
