...
PU4 & El sistema identifica correctamente los participantes del proceso (departamentos internos y actores externos). \\[4pt]
...
PU8 & En general, considero que el sistema es una herramienta valiosa para el modelado de procesos. \\[4pt]
\hline
\end{tabular}
\end{table}
...
\label{tab:peou}
\begin{tabular}{@{} p{1.0cm} p{11.8cm} @{}}
\hline
\rule{0pt}{10pt}\textbf{Cód.} & \textbf{Ítem} \\
\hline
...
PEOU4 & El número de preguntas que formula el sistema durante la generación guiada es adecuado (ni excesivo ni insuficiente). \\[4pt]
...
PEOU8 & En general, considero que el sistema es fácil de usar. \\[4pt]
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{@{} p{0.7cm} p{6.8cm} p{5.0cm} @{}}
\hline
